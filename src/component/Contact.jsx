  ...
  return (
    <section className="relative bg-black text-white min-h-screen w-full py-16 px-6 md:px-12 lg:px-20 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="w-[700px] h-[700px] bg-blue-600/30 rounded-full blur-[200px] absolute -top-40 -left-40"></div>
        <div className="w-[500px] h-[500px] bg-blue-500/20 rounded-full blur-[180px] absolute bottom-0 right-0"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col justify-center h-full">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mt-6 leading-snug">
